...
<html>
	...
	<body>
			...
			<div id='content' data-role='content'>
				...
				<div id="dropUtil" style="display: none; padding: 5px; border: 1px solid rgb(197,199,199);margin: 5px; margin-top: 0px;border-radius: 3px;">
					...
					<div action='' method=''>
						...
						<input name="btnpurchase" id="btnpurchase" type="button" value="Purchase" data-theme="a">
					</div>
				...
				<input  data-icon="back" data-rel="back" title="Go back"  type="button" value="LOG OUT" data-theme="b">
				</a>
		...
		$url = "http://localhost/Bankk/php/utilities.php";
		$myvars = 'utility=' . $utility . '&amount=' . $amount. '&phone=' . $phone;
...
<script type="text/javascript" >
	$(document).ready(function() {
		...
		$('#btnBalance').click(function() {
			...
			// $.get("bal.php", function(data) {
			$.get("http://216.224.161.207/ecobankmobile1/php/bal.php", function(data) {
				$('#dropBal').slideToggle();
				$('#dropBal').html(data);
			});
		})
		...
		$('#btnpurchase').click(function() {
			// alert('yes');
			// $.post("utilities.php", {
			$.post("http://216.224.161.207/ecobankmobile1/php/utilities.php", {
				utility : $(".utilradio").val(),
